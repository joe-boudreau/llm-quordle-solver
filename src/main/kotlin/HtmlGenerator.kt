        ...
        head {
            ...
            style {
                ...
                .container { display: flex; height: 100vh; }
                    ...
                    .board-container { background: #ffffff; padding: 10px; border-radius: 4px; display: flex; flex-direction: column; }
                    .board { display: grid; grid-template-columns: repeat(5, 1fr); gap: 4px; width: 100%; margin-bottom: 10px; }
                    .tile { width: 100%; aspect-ratio: 1; display: flex; justify-content: center; align-items: center; font-weight: bold; color: #000; }
